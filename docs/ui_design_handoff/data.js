...
const FEEDS = [
  { id: 1, name: "Julia Evans",       url: "jvns.ca",            color: "#d63384" },
  { id: 2, name: "Dan Luu",           url: "danluu.com",         color: "#1a1a1a" },
  { id: 3, name: "Drew DeVault",      url: "drewdevault.com",    color: "#7a4ddb" },
  { id: 4, name: "Fabien Sanglard",   url: "fabiensanglard.net", color: "#c9520f" },
  { id: 5, name: "lobste.rs",         url: "lobste.rs",          color: "#a6794d" },
  { id: 6, name: "Hillel Wayne",      url: "buttondown.email/hillelwayne", color: "#2b8a3e" },
  { id: 7, name: "Computer Things",   url: "buttondown.email/hillelwayne", color: "#1971c2" },
  { id: 8, name: "Eli Bendersky",     url: "eli.thegreenplace.net", color: "#5c940d" },
  { id: 9, name: "Phoronix",          url: "phoronix.com",       color: "#e67700" },
  { id: 10, name: "LWN.net",          url: "lwn.net",            color: "#495057" },
  { id: 11, name: "Simon Willison",   url: "simonwillison.net",  color: "#0b7285" },
  { id: 12, name: "rachelbythebay",   url: "rachelbythebay.com", color: "#862e9c" },
];
