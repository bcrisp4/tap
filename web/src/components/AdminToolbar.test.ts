...
describe('AdminToolbar', () => {
  it('renders search input and four filter chips', () => {
    render(AdminToolbar, { props: { filter: 'all', query: '' } });
  ...
  it('marks the active filter chip', () => {
    render(AdminToolbar, { props: { filter: 'admins', query: '' } });
  ...
  it('fires onFilter when chip clicked', async () => {
    ...
    render(AdminToolbar, { props: { filter: 'all', query: '', onFilter } });
  ...
  it('fires onQuery on input', async () => {
    const onQuery = vi.fn();
    render(AdminToolbar, { props: { filter: 'all', query: '', onQuery } });
  ...
  it('fires onCreate when "Create user" clicked', async () => {
    ...
    render(AdminToolbar, { props: { filter: 'all', query: '', onCreate } });
